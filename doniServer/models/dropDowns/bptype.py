...
class BusinessType(models.Model):
    ...
    created_by = models.ForeignKey(User, null=False, blank=False, related_name='business_type_created_by')
    updated_by = models.ForeignKey(User, null=True, blank=False, related_name='business_type_updated_by')
