...
class Designation(models.Model):
    ...
    created_by = models.ForeignKey(User, null=False, blank=False, related_name='designation_created_by')
    updated_by = models.ForeignKey(User, null=True, blank=False, related_name='designation_updated_by')
